 ...
 *   <li>CLOSED: the account has been closed by the user. Account balance must be empty before user can close an account. This status prevents all further transactions on the account.</li>
 * </ul>
 */
